...
let btmMenu = document.createElement("div") ;
btmMenu.setAttribute("id","bottom-menu") ;
btmMenu.innerHTML += (`<p class="choice" id="home-choice" data-choice="home">Home</p>`);
btmMenu.innerHTML += (`<p class="choice" id="menu-choice" data-choice="menu">Menu</p>`);
btmMenu.innerHTML += (`<p class="choice" id="about-choice" data-choice="about">About</p>`)

content.appendChild(topBanner) ;
content.appendChild(btmMenu) ;
